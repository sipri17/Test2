...
export default function JobListInfinityScroll() {
    ...
    const fetchJobs = async () => {
        try {
            ...
            const res = await fetch(`${baseUrl}/jobs?page=${page}&description=${description}&location=${location}`, {
                headers: {
            ...
            if (data.length) setJobs((prevData) => [...prevData, ...data])
    ...
    return (
        <>
            ...
            <div className="d-style text-center border-2 bgc-white   w-100 my-2 py-3 shadow-sm ">
                <h2>Job List</h2>
                        ...
                        <div className="box-root padding-top--24 flex-flex flex-direction--column" style={{ flexGrow: 1, zIndex: 9 }}>
                            ...
                            <div>
                                <div className="container">
                                    ...
                                    <button onClick={() => setPage((prevPage) => prevPage + 1)} className="f-n-hover btn btn-info btn-raised px-4 py-25 w-100 text-600">More Jobs</button>
                                </div>
                            </div>
